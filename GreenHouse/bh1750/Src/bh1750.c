...
//Sends one 8-bit command to BH1750 (datasheet: one command per STOP)
...
//Properly initialize BH1750 according to datasheet state machine:
...
// Reads 16-bit light data from BH1750 and converts it to lux.
//
